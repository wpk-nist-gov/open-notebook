...
version-import: ## check version from python import
	-$(UVRUN) python -c 'import open_notebook; print(open_notebook.__version__)'
...
tuna-import	: ## Analyze load time for module
	$(UVRUN) python -X importtime -c 'import open_notebook' 2> tuna-loadtime.log
